...
func _run() -> void:
	...
	if not (runtime_path.ends_with("main_v050_hotfix.gd") or runtime_path.ends_with("main_v051.gd") or runtime_path.ends_with("main_v052.gd") or runtime_path.ends_with("main_v053.gd") or runtime_path.ends_with("main_v054.gd")):
