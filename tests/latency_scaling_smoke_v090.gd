...
func _run() -> void:
	...
	if not (runtime_path.ends_with("main_v090.gd") or runtime_path.ends_with("main_v091.gd") or runtime_path.ends_with("main_v092.gd") or runtime_path.ends_with("main_v093.gd") or runtime_path.ends_with("main_v094.gd")):
	...
	if runtime_path.ends_with("main_v091.gd") or runtime_path.ends_with("main_v092.gd") or runtime_path.ends_with("main_v093.gd") or runtime_path.ends_with("main_v094.gd"):
		for _i in range(3):
			await process_frame
